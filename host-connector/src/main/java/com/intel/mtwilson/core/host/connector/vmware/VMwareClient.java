...
public class VMwareClient implements TlsClient {
     ...
     * @param url ESXI cluster url
     * @param userName Username to login to the cluster
     * @param password Password to login to the cluster
     * @throws NoSuchAlgorithmException This method throws NoSuchAlgorithmException
     * @throws KeyManagementException This method throws KeyManagementException
...
//        log.debug("VSPHERE: Connection string: {}", vCenterConnectionString);
     ...
     * @return ManagedObjectReference java model object.
     * @throws RemoteException This method throws RemoteException.
     */
...
//        ServiceContent sc = vimPort.retrieveServiceContent(hostRef)
    ...
    public List<String> getPropertyNames(HostInfo hostObj) throws InvalidProperty, RuntimeFault, RemoteException, VMwareConnectionException {
        // Return object array
        ArrayList<String> list = new ArrayList<String>();
        ManagedObjectReference moRef = getDecendentMoRef(null, "HostSystem", hostObj.getHostName());
     ...
     * @param hostName name of the host.
     * @return ManagedEntity java model object.
     * @throws RemoteException This method throws RemoteException.
     * @throws InvalidProperty This method throws InvalidProperty.
     * @throws RuntimeFault This method throws RuntimeFault.
     * 
     */
...
//    }
    ...
    public HostInfo getHostDetails(HostInfo hostObj, String vCenterConnectionString) throws VMwareConnectionException {
        ...
        try {
            ...
            hostMOR = getDecendentMoRef(null, "HostSystem", hostObj.getHostName());
            if (hostMOR == null) {
                throw new Exception("Host specified does not exist in the vCenter.");
            }

            hostObj.setHostName(getStringMEProperty("HostSystem", hostObj.getHostName(), "name"));
            // hostObj.Description = serviceContent.getAbout().getVersion());
            hostObj.setOsName(getStringMEProperty("HostSystem", hostObj.getHostName(), "config.product.name"));
            hostObj.setOsVersion(getStringMEProperty("HostSystem", hostObj.getHostName(), "config.product.version"));
            hostObj.setVmmVersion(getStringMEProperty("HostSystem", hostObj.getHostName(), "config.product.build"));
            hostObj.setBiosName(getStringMEProperty("HostSystem", hostObj.getHostName(), "hardware.systemInfo.vendor"));
            hostObj.setBiosVersion(getStringMEProperty("HostSystem", hostObj.getHostName(), "hardware.biosInfo.biosVersion"));
     ...
     * @throws VMwareConnectionException This method throws VMwareConnectionException
     * @throws ASException This method throws ASException
     */
    public ArrayList getHostDetailsForCluster(String clusterName, String vCenterConnectionString) throws VMwareConnectionException, ASException {
        ArrayList hostList;
        ArrayList hostDetailList = new ArrayList<HostInfo>();
        ...
        try {
            ...
            for (int i = 0; i < hostList.size(); i++) {
                ...
                HostInfo hostObj = new HostInfo();
                hostObj.setHostName( hostName);
                //hostObj.setConnectionString ( vCenterConnectionString );
                hostObj = getHostDetails(hostObj, vCenterConnectionString);
     ...
     * @throws InvalidProperty This method throws InvalidProperty exception
     * @throws RuntimeFault This method throws RuntimeFault exception
     * @throws RemoteException This method throws RemoteException
     */
    ...
    public ArrayList getHostNamesForCluster(String clusterName) throws InvalidProperty, RuntimeFault, RemoteException {
        ArrayList<HostInfo> hostDetailList = new ArrayList<HostInfo>();
        ...
        for (ManagedEntity me : mes) {
            if (me.getParent().getName().trim().equalsIgnoreCase(clusterName.trim())) {
                ...
                if (connectionState.equalsIgnoreCase("connected")) {
                    ...
                    HostInfo hostObj = new HostInfo();
                    hostObj.setHostName(me.getName());
                    //hostObj.setConnectionString(vmwareConnectionString);
                    hostObj.setOsName(getMEProperty("HostSystem", hostObj.getHostName(), "config.product.name").toString());
                    hostObj.setOsVersion(getMEProperty("HostSystem", hostObj.getHostName(), "config.product.version").toString());
                    hostObj.setVmmVersion(getMEProperty("HostSystem", hostObj.getHostName(), "config.product.build").toString());
                    hostObj.setBiosName(getMEProperty("HostSystem", hostObj.getHostName(), "hardware.systemInfo.vendor").toString());
                    hostObj.setBiosVersion(getMEProperty("HostSystem", hostObj.getHostName(), "hardware.biosInfo.biosVersion").toString());
                    hostDetailList.add(hostObj);
                } else {
     ...
     * @param hostObj HostInfo java model object
     * @param pcrList PCR values
     * @return Attestation report in string format
     * @throws VMwareConnectionException This method throws VMwareConnectionException
     */
    public String getHostAttestationReport(HostInfo hostObj, String pcrList) throws VMwareConnectionException {
        ManagedObjectReference hostMOR = getDecendentMoRef(null, "HostSystem", hostObj.getHostName());
        if (hostMOR == null) {
            throw new VMwareConnectionException("Host specified does not exist in the vCenter.");
        }
        return getHostAttestationReport(hostMOR, hostObj.getHostName(), pcrList);
    }
     ...
     * @param hostMOR : ManagedObjectReference java model object
...
//        boolean doNotDisconnect;
        ...
        try {
            ...
            if (tpmSupport == true && (isModuleAttestationSupportedByVcenter(getVCenterVersion()))) {
                ...
                if(!hostTrustReport.tpmLogReliable) {
